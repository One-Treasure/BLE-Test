...
Page({
  ...
  bindPickerChange: function (ret) {
    ...
    console.log('bindPickerChange', array[ret.detail.value]);
    this.setData({
  ...
  bleConfigEvent: function (ret) {
    ...
    console.log("bleConfigEvent 选中:" + deviceID);
    ...
    console.log('bleConfigEvent id', id);
  ...
  getBLECharactedId: function (deviceId, serviceId) {
    ...
    wx.getBLEDeviceCharacteristics({
      ...
      serviceId: serviceId,
      success: function (res) {
        console.log('getBLECharactedId', res);
  ...
  sendBLECharacterNotice: function (deviceId, serviceId, charId) {
    ...
    console.log("file: index.js - line 320 - buffer", buffer)
    setTimeout(function () {
      wx.writeBLECharacteristicValue({
        ...
        value: buffer,
        success: function (res) {
          console.log("file: index.js - line 328 - setTimeout - res", res)
